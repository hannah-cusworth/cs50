...
A set of SQL queries which answer a list of questions about movies. The database consists of data from IMDb stored in five related tables: movies, people, ratings, stars and directors.

[Specification.](https://cs50.harvard.edu/x/2020/psets/7/movies/)
